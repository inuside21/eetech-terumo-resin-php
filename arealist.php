                ...
                <div class=content>
                    <div class=content-header>
                        ...
                        <div class=header-title>
                            <h1>Area List</h1>
                            <small>View all saved Area Details</small>
                            <ol class=breadcrumb>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    ...
                                    <div class=n2Status>
                                        <div id="fButton">
                                            <a id="" href="areaadd.php"><span class="ti-support"></span> Add New</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    foreach($rowArea as $value) {
                                                ?>
                                                    <tr onclick="window.location.href='areaview.php?id=<?php echo $value->id; ?>';">
                                                        <td><?php echo $value->area_name; ?></td>
                                                        <td><?php echo $value->area_oic; ?></td>
                                                    </tr>
                                                <?php
                                                    }
                                                ?>
