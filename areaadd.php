                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class=nav id=side-menu>
                        ...
                        <li class=active>
                            ...
                            <ul class="nav nav-second-level">
                                <li class=active><a href="areaadd.php">Add Area</a></li>
                ...
                <div class=content>
                    <div class=content-header>
                        ...
                        <div class=header-title>
                            <h1>Add New Area Information</h1>
                            <small>Create new entry for Area</small>
                            <ol class=breadcrumb>
                                    ...
                                    <form id="fInfo" action="asdsad.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 p-l-30 p-r-30">
                                                ...
                                                <p class="m-b-20 text-center">Details and information of new area</p><br>

                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Name / ID</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" placeholder="" id="example-text-input" name="aName" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">OIC</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" placeholder="" id="example-text-input" name="aOwner" required>
                                                    </div>
                                                </div>
